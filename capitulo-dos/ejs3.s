...
00010318 <_start>:
   ...
   10348:       000104dc        .word   0x000104dc
   1034c:       00010408        .word   0x00010408
   10350:       0001047c        .word   0x0001047c
...
000103a4 <register_tm_clones>:
   103a4:       e59f0024        ldr     r0, [pc, #36]   ; 103d0 <register_tm_clones+0x2c>   103a8:       e59f1024        ldr     r1, [pc, #36]   ; 103d4 <register_tm_clones+0x30>   103ac:       e0411000        sub     r1, r1, r0
   103b0:       e1a01141        asr     r1, r1, #2
   103b4:       e0811fa1        add     r1, r1, r1, lsr #31
   103b8:       e1b010c1        asrs    r1, r1, #1
   103bc:       012fff1e        bxeq    lr
   103c0:       e59f3010        ldr     r3, [pc, #16]   ; 103d8 <register_tm_clones+0x34>   103c4:       e3530000        cmp     r3, #0
...
00010408 <main>:
   ...
   1041c:       ea00000d        b       10458 <main+0x50>
   10420:       e51b3008        ldr     r3, [fp, #-8]
   10424:       e2033001        and     r3, r3, #1
   10428:       e3530000        cmp     r3, #0
   1042c:       0a000003        beq     10440 <main+0x38>
   10430:       e51b1008        ldr     r1, [fp, #-8]
   10434:       e59f0038        ldr     r0, [pc, #56]   ; 10474 <main+0x6c>
   10438:       ebffffaa        bl      102e8 <printf@plt>
   1043c:       ea000002        b       1044c <main+0x44>
   10440:       e51b1008        ldr     r1, [fp, #-8]
   10444:       e59f002c        ldr     r0, [pc, #44]   ; 10478 <main+0x70>
   10448:       ebffffa6        bl      102e8 <printf@plt>
   1044c:       e51b3008        ldr     r3, [fp, #-8]
   10450:       e2833001        add     r3, r3, #1
   10454:       e50b3008        str     r3, [fp, #-8]
   10458:       e51b3008        ldr     r3, [fp, #-8]
   1045c:       e3530009        cmp     r3, #9
   10460:       daffffee        ble     10420 <main+0x18>
   10464:       e3a03000        mov     r3, #0
   10468:       e1a00003        mov     r0, r3
   1046c:       e24bd004        sub     sp, fp, #4
   10470:       e8bd8800        pop     {fp, pc}
   10474:       000104ec        .word   0x000104ec
   10478:       000104fc        .word   0x000104fc

0001047c <__libc_csu_init>:
   1047c:       e92d47f0        push    {r4, r5, r6, r7, r8, r9, sl, lr}
   10480:       e1a07000        mov     r7, r0
   10484:       e59f6048        ldr     r6, [pc, #72]   ; 104d4 <__libc_csu_init+0x58>
   10488:       e59f5048        ldr     r5, [pc, #72]   ; 104d8 <__libc_csu_init+0x5c>
   1048c:       e08f6006        add     r6, pc, r6
   10490:       e08f5005        add     r5, pc, r5
   10494:       e0466005        sub     r6, r6, r5
   10498:       e1a08001        mov     r8, r1
   1049c:       e1a09002        mov     r9, r2
   104a0:       ebffff88        bl      102c8 <_init>
   104a4:       e1b06146        asrs    r6, r6, #2
   104a8:       08bd87f0        popeq   {r4, r5, r6, r7, r8, r9, sl, pc}
   104ac:       e3a04000        mov     r4, #0
   104b0:       e2844001        add     r4, r4, #1
   104b4:       e4953004        ldr     r3, [r5], #4
   104b8:       e1a02009        mov     r2, r9
   104bc:       e1a01008        mov     r1, r8
   104c0:       e1a00007        mov     r0, r7
   104c4:       e12fff33        blx     r3
   104c8:       e1560004        cmp     r6, r4
   104cc:       1afffff7        bne     104b0 <__libc_csu_init+0x34>
   104d0:       e8bd87f0        pop     {r4, r5, r6, r7, r8, r9, sl, pc}
   104d4:       00010a80        .word   0x00010a80
   104d8:       00010a78        .word   0x00010a78

000104dc <__libc_csu_fini>:
   104dc:       e12fff1e        bx      lr

Disassembly of section .fini:

000104e0 <_fini>:
   104e0:       e92d4008        push    {r3, lr}
   104e4:       e8bd8008        pop     {r3, pc}
